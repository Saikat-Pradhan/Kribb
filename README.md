...
![NativeWind](https://img.shields.io/badge/Frontend-NativeWind-darkblue?logo=react)

Kribb is a modern mobile app built with React Native and Expo that helps users find their dream homes effortlessly.

It connects to a Supabase backend for secure authentication and real-time property listings, allowing users to browse featured apartments, villas, houses, and studios across major Indian cities. Users can save favorite properties, view detailed descriptions, and explore high-quality images — all within a smooth, responsive interface.
